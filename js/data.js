...
const DB = {
  ...
  products: [
    ...
    { id:'P001',code:'CAB001',name:'Cable USB-C a USB-C Anker 240W 2m',        catId:'C01',buyP:8,   sellP:15,  stock:45, minStock:15, unit:'und',status:'active',supId:'S01',sold:280,image:null },
    { id:'P002',code:'CAB002',name:'Cable HDMI 4K 60Hz Ugreen 3m',             catId:'C01',buyP:7,   sellP:12,  stock:60, minStock:20, unit:'und',status:'active',supId:'S01',sold:320,image:null },
    { id:'P003',code:'CAB003',name:'Cable USB-A a Lightning iPhone 2m',         catId:'C01',buyP:6,   sellP:10,  stock:55, minStock:18, unit:'und',status:'active',supId:'S01',sold:290,image:null },
    { id:'P004',code:'CAB004',name:'Hub USB-C 7 en 1 Anker 555',               catId:'C01',buyP:22,  sellP:38,  stock:28, minStock:10, unit:'und',status:'active',supId:'S01',sold:145,image:null },
    { id:'P005',code:'CAB005',name:'Cable Auxiliar 3.5mm Trenzado 1.5m',       catId:'C01',buyP:3,   sellP:6,   stock:80, minStock:25, unit:'und',status:'active',supId:'S01',sold:420,image:null },
    { id:'P006',code:'CAB006',name:'Adaptador HDMI a VGA Full HD',              catId:'C01',buyP:8,   sellP:14,  stock:35, minStock:12, unit:'und',status:'active',supId:'S01',sold:185,image:null },
    { id:'P007',code:'CAB007',name:'Cable Micro-USB Trenzado 1m Ugreen',       catId:'C01',buyP:4,   sellP:7,   stock:70, minStock:20, unit:'und',status:'active',supId:'S01',sold:350,image:null },
    { id:'P008',code:'CAB008',name:'Adaptador USB-C a Jack 3.5mm',             catId:'C01',buyP:5,   sellP:9,   stock:50, minStock:15, unit:'und',status:'active',supId:'S01',sold:260,image:null },
    { id:'P009',code:'CAB009',name:'Cable DisplayPort 4K 144Hz 2m',            catId:'C01',buyP:12,  sellP:20,  stock:22, minStock:8,  unit:'und',status:'active',supId:'S01',sold:110,image:null },
    { id:'P010',code:'CAB010',name:'Extensión USB 3.0 de 3m',                  catId:'C01',buyP:7,   sellP:12,  stock:38, minStock:12, unit:'und',status:'active',supId:'S01',sold:195,image:null },
    { id:'P011',code:'CAB011',name:'Adaptador USB-C a HDMI 4K',               catId:'C01',buyP:10,  sellP:18,  stock:32, minStock:10, unit:'und',status:'active',supId:'S01',sold:168,image:null },
    { id:'P012',code:'CAB012',name:'Cable Ethernet Cat6 5m RJ45',              catId:'C01',buyP:5,   sellP:9,   stock:42, minStock:12, unit:'und',status:'active',supId:'S01',sold:210,image:null },

    // ===== AUDIO Y SONIDO (C02) =====
    { id:'P013',code:'AUD001',name:'Auriculares Sony WH-1000XM5 NC BT',        catId:'C02',buyP:280, sellP:385, stock:8,  minStock:3,  unit:'und',status:'active',supId:'S02',sold:42, image:null },
    { id:'P014',code:'AUD002',name:'Auriculares JBL Tune 770NC Bluetooth',      catId:'C02',buyP:85,  sellP:128, stock:12, minStock:4,  unit:'und',status:'active',supId:'S02',sold:68, image:null },
    { id:'P015',code:'AUD003',name:'TWS Samsung Galaxy Buds2 Pro',              catId:'C02',buyP:120, sellP:178, stock:10, minStock:3,  unit:'und',status:'active',supId:'S02',sold:55, image:null },
    { id:'P016',code:'AUD004',name:'TWS Xiaomi Redmi Buds 4 Pro',               catId:'C02',buyP:45,  sellP:72,  stock:20, minStock:6,  unit:'und',status:'active',supId:'S02',sold:115,image:null },
    { id:'P017',code:'AUD005',name:'Parlante Bluetooth JBL Charge 5',           catId:'C02',buyP:95,  sellP:148, stock:14, minStock:5,  unit:'und',status:'active',supId:'S02',sold:88, image:null },
    { id:'P018',code:'AUD006',name:'Parlante Bluetooth Sony SRS-XB43',          catId:'C02',buyP:110, sellP:168, stock:10, minStock:3,  unit:'und',status:'active',supId:'S02',sold:62, image:null },
    { id:'P019',code:'AUD007',name:'Micrófono USB Blue Snowball iCE',           catId:'C02',buyP:45,  sellP:72,  stock:8,  minStock:3,  unit:'und',status:'active',supId:'S02',sold:38, image:null },
    { id:'P020',code:'AUD008',name:'Auriculares Gaming HyperX Cloud II',        catId:'C02',buyP:65,  sellP:98,  stock:12, minStock:4,  unit:'und',status:'active',supId:'S02',sold:72, image:null },
    { id:'P021',code:'AUD009',name:'Parlante Portátil Anker SoundCore 3',       catId:'C02',buyP:38,  sellP:62,  stock:18, minStock:6,  unit:'und',status:'active',supId:'S02',sold:95, image:null },
    { id:'P022',code:'AUD010',name:'Soundbar Xiaomi 2.0 80W BT',               catId:'C02',buyP:85,  sellP:132, stock:7,  minStock:2,  unit:'und',status:'active',supId:'S02',sold:45, image:null },
    { id:'P023',code:'AUD011',name:'Auriculares In-Ear Jabra Elite 4 Active',   catId:'C02',buyP:58,  sellP:88,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S02',sold:78, image:null },
    { id:'P024',code:'AUD012',name:'Altavoz Portátil JBL Go 4',                catId:'C02',buyP:28,  sellP:45,  stock:22, minStock:7,  unit:'und',status:'active',supId:'S02',sold:125,image:null },

    // ===== FOTOGRAFÍA Y VIDEO (C03) =====
    { id:'P025',code:'FOT001',name:'Cámara GoPro Hero 12 Black',               catId:'C03',buyP:320, sellP:428, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S03',sold:28, image:null },
    { id:'P026',code:'FOT002',name:'Cámara Sony ZV-E10 Mirrorless Kit 16-50',  catId:'C03',buyP:580, sellP:780, stock:4,  minStock:1,  unit:'und',status:'active',supId:'S03',sold:15, image:null },
    { id:'P027',code:'FOT003',name:'Cámara de Acción AKASO V50 Elite 4K',      catId:'C03',buyP:75,  sellP:115, stock:10, minStock:3,  unit:'und',status:'active',supId:'S03',sold:52, image:null },
    { id:'P028',code:'FOT004',name:'Gimbal Zhiyun Smooth 5S para Celular',     catId:'C03',buyP:95,  sellP:148, stock:8,  minStock:2,  unit:'und',status:'active',supId:'S03',sold:38, image:null },
    { id:'P029',code:'FOT005',name:'Memoria SD SanDisk Extreme 128GB V30',     catId:'C03',buyP:18,  sellP:28,  stock:35, minStock:10, unit:'und',status:'active',supId:'S03',sold:195,image:null },
    { id:'P030',code:'FOT006',name:'Memoria SD Samsung Pro Plus 256GB',        catId:'C03',buyP:28,  sellP:45,  stock:25, minStock:8,  unit:'und',status:'active',supId:'S03',sold:148,image:null },
    { id:'P031',code:'FOT007',name:'Trípode Flexible Joby GorillaPod 3K',      catId:'C03',buyP:28,  sellP:45,  stock:18, minStock:5,  unit:'und',status:'active',supId:'S03',sold:95, image:null },
    { id:'P032',code:'FOT008',name:'Ring Light LED 10" con Tripié y Soporte',  catId:'C03',buyP:22,  sellP:38,  stock:20, minStock:6,  unit:'und',status:'active',supId:'S03',sold:125,image:null },
    { id:'P033',code:'FOT009',name:'Filtro ND Variable 58mm para Cámara',      catId:'C03',buyP:18,  sellP:30,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S03',sold:68, image:null },
    { id:'P034',code:'FOT010',name:'Batería Extra NP-FZ100 para Sony Alpha',   catId:'C03',buyP:22,  sellP:35,  stock:20, minStock:6,  unit:'und',status:'active',supId:'S03',sold:88, image:null },
    { id:'P035',code:'FOT011',name:'Bolso Lowepro Fastpack BP 250 AW II',      catId:'C03',buyP:48,  sellP:75,  stock:8,  minStock:2,  unit:'und',status:'active',supId:'S03',sold:42, image:null },
    { id:'P036',code:'FOT012',name:'Control Remoto Wi-Fi para GoPro Hero 12',  catId:'C03',buyP:25,  sellP:40,  stock:12, minStock:4,  unit:'und',status:'active',supId:'S03',sold:58, image:null },

    // ===== DRONES (C04) =====
    { id:'P037',code:'DRO001',name:'DJI Mini 4 Pro Drone 4K/60fps',            catId:'C04',buyP:680, sellP:920, stock:5,  minStock:2,  unit:'und',status:'active',supId:'S04',sold:18, image:null },
    { id:'P038',code:'DRO002',name:'DJI Air 3 Combo Fly More',                 catId:'C04',buyP:1050,sellP:1380,stock:3,  minStock:1,  unit:'und',status:'active',supId:'S04',sold:8,  image:null },
    { id:'P039',code:'DRO003',name:'DJI Mini 3 Drone Solo',                    catId:'C04',buyP:480, sellP:650, stock:4,  minStock:1,  unit:'und',status:'active',supId:'S04',sold:14, image:null },
    { id:'P040',code:'DRO004',name:'DJI Avata 2 FPV Combo',                    catId:'C04',buyP:750, sellP:980, stock:3,  minStock:1,  unit:'und',status:'active',supId:'S04',sold:10, image:null },
    { id:'P041',code:'DRO005',name:'Holy Stone HS720E 4K GPS Drone',           catId:'C04',buyP:120, sellP:185, stock:8,  minStock:2,  unit:'und',status:'active',supId:'S04',sold:35, image:null },
    { id:'P042',code:'DRO006',name:'Batería Inteligente DJI Mini 4 Pro',       catId:'C04',buyP:52,  sellP:82,  stock:15, minStock:5,  unit:'und',status:'active',supId:'S04',sold:55, image:null },
    { id:'P043',code:'DRO007',name:'Control Remoto DJI RC2 con Pantalla',      catId:'C04',buyP:180, sellP:250, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S04',sold:22, image:null },
    { id:'P044',code:'DRO008',name:'Kit de Carga Múltiple DJI Mini 4 Pro',     catId:'C04',buyP:65,  sellP:98,  stock:8,  minStock:3,  unit:'und',status:'active',supId:'S04',sold:28, image:null },
    { id:'P045',code:'DRO009',name:'Bolsa de Transporte Shoulder DJI',         catId:'C04',buyP:28,  sellP:45,  stock:12, minStock:4,  unit:'und',status:'active',supId:'S04',sold:42, image:null },
    { id:'P046',code:'DRO010',name:'Protector de Hélices DJI Mini 4 Pro',     catId:'C04',buyP:8,   sellP:14,  stock:25, minStock:8,  unit:'und',status:'active',supId:'S04',sold:88, image:null },
    { id:'P047',code:'DRO011',name:'Filtros ND DJI Mini 4 Pro Set x4',        catId:'C04',buyP:35,  sellP:55,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S04',sold:48, image:null },
    { id:'P048',code:'DRO012',name:'Potensic ATOM SE 4K GPS Drone',           catId:'C04',buyP:145, sellP:215, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S04',sold:25, image:null },

    // ===== SMARTPHONES Y ACCESORIOS (C05) =====
    { id:'P049',code:'SMT001',name:'Samsung Galaxy S23 FE 256GB',              catId:'C05',buyP:380, sellP:520, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S05',sold:22, image:null },
    { id:'P050',code:'SMT002',name:'Xiaomi 13T Pro 256GB',                     catId:'C05',buyP:320, sellP:440, stock:8,  minStock:3,  unit:'und',status:'active',supId:'S05',sold:28, image:null },
    { id:'P051',code:'SMT003',name:'Cargador Inalámbrico 15W Qi MagSafe',      catId:'C05',buyP:18,  sellP:32,  stock:30, minStock:10, unit:'und',status:'active',supId:'S05',sold:148,image:null },
    { id:'P052',code:'SMT004',name:'Cargador Rápido 65W GaN USB-C',            catId:'C05',buyP:22,  sellP:38,  stock:35, minStock:12, unit:'und',status:'active',supId:'S05',sold:195,image:null },
    { id:'P053',code:'SMT005',name:'Power Bank Xiaomi 33W 20000mAh',           catId:'C05',buyP:28,  sellP:48,  stock:25, minStock:8,  unit:'und',status:'active',supId:'S05',sold:165,image:null },
    { id:'P054',code:'SMT006',name:'Soporte Magnético para Auto Ventilación',  catId:'C05',buyP:10,  sellP:18,  stock:45, minStock:15, unit:'und',status:'active',supId:'S05',sold:280,image:null },
    { id:'P055',code:'SMT007',name:'Funda Protectora Samsung S23 Ultra',       catId:'C05',buyP:8,   sellP:14,  stock:50, minStock:15, unit:'und',status:'active',supId:'S05',sold:320,image:null },
    { id:'P056',code:'SMT008',name:'Vidrio Templado iPhone 15 Pro Max',        catId:'C05',buyP:5,   sellP:9,   stock:60, minStock:20, unit:'und',status:'active',supId:'S05',sold:380,image:null },
    { id:'P057',code:'SMT009',name:'Anillo de Luz LED para Celular 26cm',      catId:'C05',buyP:15,  sellP:28,  stock:22, minStock:7,  unit:'und',status:'active',supId:'S05',sold:112,image:null },
    { id:'P058',code:'SMT010',name:'Pop Socket MagSafe Premium',               catId:'C05',buyP:8,   sellP:15,  stock:40, minStock:12, unit:'und',status:'active',supId:'S05',sold:225,image:null },
    { id:'P059',code:'SMT011',name:'Soporte Escritorio Ajustable para Celular',catId:'C05',buyP:12,  sellP:22,  stock:30, minStock:10, unit:'und',status:'active',supId:'S05',sold:155,image:null },
    { id:'P060',code:'SMT012',name:'Funda Anti-Shock con Tapa iPhone 15',      catId:'C05',buyP:10,  sellP:18,  stock:35, minStock:10, unit:'und',status:'active',supId:'S05',sold:210,image:null },

    // ===== CÓMPUTO Y PERIFÉRICOS (C06) =====
    { id:'P061',code:'COM001',name:'Laptop Lenovo IdeaPad 5i Core i5 15.6"',  catId:'C06',buyP:480, sellP:650, stock:5,  minStock:2,  unit:'und',status:'active',supId:'S06',sold:18, image:null },
    { id:'P062',code:'COM002',name:'Mouse Logitech MX Master 3S Inalámbrico', catId:'C06',buyP:55,  sellP:85,  stock:15, minStock:5,  unit:'und',status:'active',supId:'S06',sold:82, image:null },
    { id:'P063',code:'COM003',name:'Teclado Mecánico Keychron K6 Hot Swap',   catId:'C06',buyP:78,  sellP:120, stock:10, minStock:3,  unit:'und',status:'active',supId:'S06',sold:55, image:null },
    { id:'P064',code:'COM004',name:'Monitor LG 27" IPS 144Hz FHD',            catId:'C06',buyP:220, sellP:320, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S06',sold:28, image:null },
    { id:'P065',code:'COM005',name:'Webcam Logitech C920 HD Pro 1080p',       catId:'C06',buyP:65,  sellP:98,  stock:10, minStock:3,  unit:'und',status:'active',supId:'S06',sold:48, image:null },
    { id:'P066',code:'COM006',name:'SSD Externo Samsung T7 1TB USB 3.2',      catId:'C06',buyP:85,  sellP:132, stock:12, minStock:4,  unit:'und',status:'active',supId:'S06',sold:62, image:null },
    { id:'P067',code:'COM007',name:'SSD Interno Kingston NV2 1TB NVMe',       catId:'C06',buyP:55,  sellP:82,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S06',sold:75, image:null },
    { id:'P068',code:'COM008',name:'RAM DDR4 16GB 3200MHz Kingston Fury',     catId:'C06',buyP:42,  sellP:65,  stock:18, minStock:5,  unit:'und',status:'active',supId:'S06',sold:88, image:null },
    { id:'P069',code:'COM009',name:'Mousepad XXL RGB Redragon 900x400mm',     catId:'C06',buyP:18,  sellP:30,  stock:22, minStock:7,  unit:'und',status:'active',supId:'S06',sold:115,image:null },
    { id:'P070',code:'COM010',name:'Stand Ventilado para Laptop Ajustable',   catId:'C06',buyP:22,  sellP:38,  stock:15, minStock:5,  unit:'und',status:'active',supId:'S06',sold:78, image:null },
    { id:'P071',code:'COM011',name:'Tarjeta de Captura Elgato HD60 X',        catId:'C06',buyP:120, sellP:178, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S06',sold:32, image:null },
    { id:'P072',code:'COM012',name:'Hub USB-C 4K HDMI Anker 555 8 en 1',     catId:'C06',buyP:38,  sellP:60,  stock:20, minStock:6,  unit:'und',status:'active',supId:'S06',sold:98, image:null },

    // ===== GAMING (C07) =====
    { id:'P073',code:'GAM001',name:'Control PS5 DualSense Blanco',             catId:'C07',buyP:68,  sellP:105, stock:12, minStock:4,  unit:'und',status:'active',supId:'S07',sold:75, image:null },
    { id:'P074',code:'GAM002',name:'Control Xbox Series X Inalámbrico',        catId:'C07',buyP:58,  sellP:90,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S07',sold:82, image:null },
    { id:'P075',code:'GAM003',name:'Auriculares Razer BlackShark V2 Pro BT',   catId:'C07',buyP:110, sellP:165, stock:8,  minStock:2,  unit:'und',status:'active',supId:'S07',sold:45, image:null },
    { id:'P076',code:'GAM004',name:'Mousepad Gaming SteelSeries QcK XXL',     catId:'C07',buyP:22,  sellP:38,  stock:18, minStock:5,  unit:'und',status:'active',supId:'S07',sold:98, image:null },
    { id:'P077',code:'GAM005',name:'Teclado Gaming Razer Huntsman Mini',       catId:'C07',buyP:85,  sellP:128, stock:10, minStock:3,  unit:'und',status:'active',supId:'S07',sold:55, image:null },
    { id:'P078',code:'GAM006',name:'Mouse Gaming Logitech G502 X Plus',       catId:'C07',buyP:52,  sellP:80,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S07',sold:88, image:null },
    { id:'P079',code:'GAM007',name:'Silla Gaming Secretlab Titan Evo Negro',   catId:'C07',buyP:185, sellP:280, stock:4,  minStock:1,  unit:'und',status:'active',supId:'S07',sold:18, image:null },
    { id:'P080',code:'GAM008',name:'Control Nintendo Switch Pro Controller',   catId:'C07',buyP:58,  sellP:88,  stock:10, minStock:3,  unit:'und',status:'active',supId:'S07',sold:62, image:null },
    { id:'P081',code:'GAM009',name:'Headset Gaming JBL Quantum 600 BT',       catId:'C07',buyP:78,  sellP:118, stock:8,  minStock:2,  unit:'und',status:'active',supId:'S07',sold:42, image:null },
    { id:'P082',code:'GAM010',name:'Gamepad PC EasySMX X10 Hall Effect',      catId:'C07',buyP:35,  sellP:55,  stock:15, minStock:4,  unit:'und',status:'active',supId:'S07',sold:72, image:null },
    { id:'P083',code:'GAM011',name:'Cooling Pad RGB para Laptops Gaming',      catId:'C07',buyP:22,  sellP:38,  stock:18, minStock:5,  unit:'und',status:'active',supId:'S07',sold:88, image:null },
    { id:'P084',code:'GAM012',name:'Reposa Muñecas Gel para Teclado',          catId:'C07',buyP:12,  sellP:20,  stock:25, minStock:8,  unit:'und',status:'active',supId:'S07',sold:115,image:null },

    // ===== REDES Y STREAMING (C08) =====
    { id:'P085',code:'RED001',name:'Router WiFi 6 TP-Link Archer AX3000',     catId:'C08',buyP:65,  sellP:98,  stock:10, minStock:3,  unit:'und',status:'active',supId:'S08',sold:52, image:null },
    { id:'P086',code:'RED002',name:'Chromecast con Google TV 4K',              catId:'C08',buyP:48,  sellP:75,  stock:14, minStock:4,  unit:'und',status:'active',supId:'S08',sold:78, image:null },
    { id:'P087',code:'RED003',name:'Amazon Fire TV Stick 4K Max Gen2',        catId:'C08',buyP:45,  sellP:70,  stock:12, minStock:4,  unit:'und',status:'active',supId:'S08',sold:65, image:null },
    { id:'P088',code:'RED004',name:'Repetidor WiFi TP-Link RE705X AX3000',    catId:'C08',buyP:38,  sellP:60,  stock:15, minStock:5,  unit:'und',status:'active',supId:'S08',sold:88, image:null },
    { id:'P089',code:'RED005',name:'Switch TP-Link TL-SG108E 8 Puertos',      catId:'C08',buyP:28,  sellP:45,  stock:12, minStock:4,  unit:'und',status:'active',supId:'S08',sold:62, image:null },
    { id:'P090',code:'RED006',name:'Router Mesh TP-Link Deco XE75 Pack x2',   catId:'C08',buyP:145, sellP:218, stock:6,  minStock:2,  unit:'und',status:'active',supId:'S08',sold:28, image:null },
    { id:'P091',code:'RED007',name:'Adaptador WiFi USB TP-Link Archer T3U',   catId:'C08',buyP:12,  sellP:20,  stock:22, minStock:7,  unit:'und',status:'active',supId:'S08',sold:115,image:null },
    { id:'P092',code:'RED008',name:'Cable Ethernet Cat7 10m Flat Ugreen',     catId:'C08',buyP:10,  sellP:17,  stock:30, minStock:10, unit:'und',status:'active',supId:'S08',sold:145,image:null },
    { id:'P093',code:'RED009',name:'Raspberry Pi 4 Model B 4GB',              catId:'C08',buyP:65,  sellP:98,  stock:8,  minStock:2,  unit:'und',status:'active',supId:'S08',sold:35, image:null },
    { id:'P094',code:'RED010',name:'Powerline Adapter TP-Link AV1000 x2',     catId:'C08',buyP:35,  sellP:55,  stock:10, minStock:3,  unit:'und',status:'active',supId:'S08',sold:48, image:null },
    { id:'P095',code:'RED011',name:'Antena WiFi Externa 9dBi RP-SMA',         catId:'C08',buyP:8,   sellP:14,  stock:28, minStock:8,  unit:'und',status:'active',supId:'S08',sold:88, image:null },
    { id:'P096',code:'RED012',name:'Access Point TP-Link EAP225 AC1350',      catId:'C08',buyP:45,  sellP:70,  stock:8,  minStock:2,  unit:'und',status:'active',supId:'S08',sold:42, image:null },
  ],
  ...
  config: {
    ...
    exchangeHistory:  [
      { date:'2026-03-23', rate:9.35, setBy:'W01' },
      { date:'2026-02-15', rate:9.30, setBy:'W01' },
      { date:'2026-01-10', rate:9.28, setBy:'W01' },
    ],
    paymentMethods: [
  ...
  caja: {
    current: null,
    sessions: [
      { id:'CAJ001', openedAt:'2026-03-22 08:00', closedAt:'2026-03-22 20:30', workerName:'Ana López',       workerId:'W02', openAmt:500.00, closingCount:{b200:3,b100:5,b50:8,b20:10,b10:12,c5:15,c2:20,c1:30}, closingAmt:2085.00, expectedAmt:2075.50, diff:9.50,  status:'closed', notes:'Diferencia a favor' },
      { id:'CAJ002', openedAt:'2026-03-21 08:00', closedAt:'2026-03-21 20:15', workerName:'Roberto García',  workerId:'W03', openAmt:300.00, closingCount:{b200:4,b100:3,b50:6,b20:8,b10:10,c5:12,c2:15,c1:20}, closingAmt:1835.00, expectedAmt:1835.00, diff:0.00,  status:'closed', notes:'Cierre exacto'    },
      { id:'CAJ003', openedAt:'2026-03-20 08:30', closedAt:'2026-03-20 19:45', workerName:'Carmen Villalba', workerId:'W06', openAmt:400.00, closingCount:{b200:2,b100:6,b50:5,b20:9,b10:8,c5:10,c2:18,c1:25}, closingAmt:1796.00, expectedAmt:1803.75, diff:-7.75, status:'closed', notes:'Faltante en monedas' },
    ],
    nextId: 4,
  },
  ...
  /* ---- PURCHASE ORDERS ---- */
  purchases: [
    { id:'OC001', date:'2026-03-22', supId:'S04', supName:'DJI Bolivia Distribuidor Oficial',   workId:'W01', workName:'Carlos Mendoza', items:[{prodId:'P037',prodName:'DJI Mini 4 Pro Drone',qty:5,unitCost:680,sub:3400},{prodId:'P042',prodName:'Batería DJI Mini 4 Pro',qty:20,unitCost:52,sub:1040},{prodId:'P044',prodName:'Kit Carga DJI Mini 4 Pro',qty:10,unitCost:65,sub:650}],  subtotal:5090, tax:0, total:5090, status:'received', expectedDate:'2026-03-25', receivedDate:'2026-03-25', notes:'Pedido drones mensual' },
    { id:'OC002', date:'2026-03-20', supId:'S02', supName:'Audio Premium Distribuciones',       workId:'W01', workName:'Carlos Mendoza', items:[{prodId:'P013',prodName:'Sony WH-1000XM5',qty:10,unitCost:280,sub:2800},{prodId:'P014',prodName:'JBL Tune 770NC',qty:15,unitCost:85,sub:1275},{prodId:'P017',prodName:'Parlante JBL Charge 5',qty:12,unitCost:95,sub:1140}],           subtotal:5215, tax:0, total:5215, status:'received', expectedDate:'2026-03-23', receivedDate:'2026-03-23', notes:'Pedido audio premium' },
    { id:'OC003', date:'2026-03-18', supId:'S06', supName:'CompuImport Periféricos Bolivia',    workId:'W01', workName:'Carlos Mendoza', items:[{prodId:'P061',prodName:'Laptop Lenovo IdeaPad 5i',qty:5,unitCost:480,sub:2400},{prodId:'P062',prodName:'Mouse Logitech MX Master 3S',qty:20,unitCost:55,sub:1100},{prodId:'P063',prodName:'Teclado Keychron K6',qty:10,unitCost:78,sub:780}],subtotal:4280, tax:0, total:4280, status:'received', expectedDate:'2026-03-21', receivedDate:'2026-03-21', notes:'Pedido cómputo y periféricos' },
    { id:'OC004', date:'2026-03-15', supId:'S01', supName:'CablesTech Bolivia Importaciones',   workId:'W01', workName:'Carlos Mendoza', items:[{prodId:'P001',prodName:'Cable USB-C Anker 240W',qty:100,unitCost:8,sub:800},{prodId:'P002',prodName:'Cable HDMI 4K Ugreen',qty:80,unitCost:7,sub:560},{prodId:'P004',prodName:'Hub USB-C 7 en 1 Anker',qty:30,unitCost:22,sub:660}],    subtotal:2020, tax:0, total:2020, status:'received', expectedDate:'2026-03-18', receivedDate:'2026-03-18', notes:'Reposición cables y hubs' },
    { id:'OC005', date:'2026-03-23', supId:'S03', supName:'FotoVideo Import Bolivia',           workId:'W01', workName:'Carlos Mendoza', items:[{prodId:'P025',prodName:'Cámara GoPro Hero 12 Black',qty:5,unitCost:320,sub:1600},{prodId:'P029',prodName:'SD SanDisk Extreme 128GB',qty:40,unitCost:18,sub:720},{prodId:'P035',prodName:'Bolso Lowepro BP 250 II',qty:8,unitCost:48,sub:384}], subtotal:2704, tax:0, total:2704, status:'pending',  expectedDate:'2026-03-28', receivedDate:null,         notes:'Urgente — reponer cámaras y accesorios' },
  ],

  /* ---- RETURNS ---- */
  returns: [
    { id:'DEV001', date:'2026-03-21 11:30', saleId:'V003', custId:'CU08', custName:'Carlos Jiménez Terán',   workId:'W02', workName:'Ana López',       items:[{prodId:'P013',prodName:'Auriculares Sony WH-1000XM5',qty:1,price:385,sub:385,reason:'Producto defectuoso — falla en driver izquierdo'}], total:385, refundMethod:'tarjeta', restock:false, status:'processed', notes:'Se envía a garantía con el proveedor' },
    { id:'DEV002', date:'2026-03-18 14:20', saleId:'V008', custId:'CU13', custName:'Valentina Cruz Montaño', workId:'W03', workName:'Roberto García',  items:[{prodId:'P014',prodName:'Auriculares JBL Tune 770NC',qty:1,price:128,sub:128,reason:'Color incorrecto — cliente pidió negro, se entregó blanco'}], total:128, refundMethod:'tarjeta', restock:true,  status:'processed', notes:'Se devuelve a stock, sin uso' },
    { id:'DEV003', date:'2026-03-15 10:00', saleId:'V015', custId:'CU20', custName:'Consumidor Final',        workId:'W06', workName:'Carmen Villalba', items:[{prodId:'P086',prodName:'Chromecast Google TV 4K',qty:1,price:75,sub:75,reason:'Incompatible con modelo de TV antiguo'}],                     total:75,  refundMethod:'efectivo', restock:true,  status:'processed', notes:'Producto en perfectas condiciones, vuelve a stock' },
  ],
  ...
  quotations: [
    {
      ...
      status:'pending', createdAt:'2026-03-23T09:00:00', createdBy:'W01', template:'T1', qrHash:'a1b2c3d4e5f6',
    },
    {
      ...
      status:'accepted', createdAt:'2026-03-20T10:30:00', createdBy:'W01', template:'T1', qrHash:'b2c3d4e5f6g7',
    },
    {
      ...
      status:'pending', createdAt:'2026-03-22T11:00:00', createdBy:'W01', template:'T1', qrHash:'c3d4e5f6g7h8',
    },
    {
      ...
      status:'pending', createdAt:'2026-03-21T14:00:00', createdBy:'W02', template:'T1', qrHash:'d4e5f6g7h8i9',
    },
    {
      ...
      validDays:7, validUntil:'2026-03-22', notes:'Cliente solicita precio mayorista',
      status:'rejected', createdAt:'2026-03-15T09:30:00', createdBy:'W02', template:'T1', qrHash:'e5f6g7h8i9j0',
    },
    {
      ...
      validDays:7, validUntil:'2026-03-08', notes:'Setup gaming completo',
    ...
    },
    {
      ...
      status:'pending', createdAt:'2026-03-22T16:00:00', createdBy:'W01', template:'T2', qrHash:'g7h8i9j0k1l2',
    },
    {
      ...
      status:'accepted', createdAt:'2026-03-18T11:00:00', createdBy:'W02', template:'T1', qrHash:'h8i9j0k1l2m3',
    },
    {
      ...
      status:'pending', createdAt:'2026-03-23T08:30:00', createdBy:'W02', template:'T1', qrHash:'i9j0k1l2m3n4',
    },
    {
      ...
      status:'pending', createdAt:'2026-03-21T15:30:00', createdBy:'W01', template:'T1', qrHash:'j0k1l2m3n4o5',
    },
  ],
